...
AGGREGATE cg_3dunion(geometry)
AGGREGATE cg_union(geometry)
...
AGGREGATE st_asrasteragg(geometry, double precision, raster, text, double precision, text, boolean)
...
FUNCTION _asgmledge(bigint, bigint, bigint, geometry, regclass, text, integer, integer, text, integer)
FUNCTION _asgmledge(integer, integer, integer, geometry, regclass, text, integer, integer, text, integer)
FUNCTION _asgmlface(text, bigint, regclass, text, integer, integer, text, integer)
FUNCTION _asgmlface(text, integer, regclass, text, integer, integer, text, integer)
FUNCTION _asgmlnode(bigint, geometry, text, integer, integer, text, integer)
FUNCTION _asgmlnode(integer, geometry, text, integer, integer, text, integer)
FUNCTION _checkedgelinking(bigint, bigint, bigint, bigint)
...
FUNCTION _registermissingfaces(character varying)
...
FUNCTION _st_adjacentedges(character varying, bigint, bigint)
...
FUNCTION _st_asrasteragg_finalfn(raster)
FUNCTION _st_asrasteragg_transfn(raster, geometry, double precision, raster, text, double precision, text, boolean)
...
FUNCTION _st_mintolerance(double precision)
...
FUNCTION _topogeo_addlinestringnoface(character varying, geometry, double precision)
FUNCTION _updaterastersrid(name, name, name, integer)
FUNCTION _validatetopologyedgelinking(geometry)
FUNCTION _validatetopologygetfaceshellmaximaledgering(character varying, bigint)
FUNCTION _validatetopologygetfaceshellmaximaledgering(character varying, integer)
FUNCTION _validatetopologygetringedges(bigint)
...
FUNCTION addtopogeometrycolumn(name, name, name, name, character varying, integer)
FUNCTION addtopogeometrycolumn(name, regclass, name, integer, character varying, integer)
...
FUNCTION cg_2drotate(geometry, double precision, double precision, double precision)
FUNCTION cg_3dalphawrapping(geometry, integer, integer)
FUNCTION cg_3darea(geometry)
FUNCTION cg_3dbuffer(geometry, double precision, integer, integer)
FUNCTION cg_3dconvexhull(geometry)
FUNCTION cg_3ddifference(geometry, geometry)
FUNCTION cg_3ddistance(geometry, geometry)
FUNCTION cg_3dintersection(geometry, geometry)
FUNCTION cg_3dintersects(geometry, geometry)
FUNCTION cg_3drotate(geometry, double precision, double precision, double precision, double precision)
FUNCTION cg_3dscale(geometry, double precision, double precision, double precision)
FUNCTION cg_3dscalearoundcenter(geometry, double precision, double precision, double precision, double precision, double precision, double precision)
FUNCTION cg_3dtranslate(geometry, double precision, double precision, double precision)
FUNCTION cg_3dunion(geometry, geometry)
FUNCTION cg_alphashape(geometry, double precision, boolean)
FUNCTION cg_approxconvexpartition(geometry)
FUNCTION cg_approximatemedialaxis(geometry)
FUNCTION cg_area(geometry)
FUNCTION cg_constraineddelaunaytriangles(geometry)
FUNCTION cg_difference(geometry, geometry)
FUNCTION cg_distance(geometry, geometry)
FUNCTION cg_extrude(geometry, double precision, double precision, double precision)
FUNCTION cg_extrudestraightskeleton(geometry, double precision, double precision)
FUNCTION cg_forcelhr(geometry)
FUNCTION cg_greeneapproxconvexpartition(geometry)
FUNCTION cg_intersection(geometry, geometry)
FUNCTION cg_intersects(geometry, geometry)
FUNCTION cg_isplanar(geometry)
FUNCTION cg_issolid(geometry)
FUNCTION cg_makesolid(geometry)
FUNCTION cg_minkowskisum(geometry, geometry)
FUNCTION cg_optimalalphashape(geometry, boolean, integer)
FUNCTION cg_optimalconvexpartition(geometry)
FUNCTION cg_orientation(geometry)
FUNCTION cg_rotate(geometry, double precision)
FUNCTION cg_rotatex(geometry, double precision)
FUNCTION cg_rotatey(geometry, double precision)
FUNCTION cg_rotatez(geometry, double precision)
FUNCTION cg_scale(geometry, double precision)
FUNCTION cg_simplify(geometry, double precision, boolean)
FUNCTION cg_straightskeleton(geometry, boolean)
FUNCTION cg_straightskeletonpartition(geometry, boolean)
FUNCTION cg_tesselate(geometry)
FUNCTION cg_translate(geometry, double precision, double precision)
FUNCTION cg_triangulate(geometry)
FUNCTION cg_union(geometry, geometry)
FUNCTION cg_visibility(geometry, geometry)
FUNCTION cg_visibility(geometry, geometry, geometry)
FUNCTION cg_volume(geometry)
FUNCTION cg_ymonotonepartition(geometry)
...
FUNCTION createtopogeom(character varying, integer, integer, topoelementarray, bigint)
...
FUNCTION createtopology(name, integer, double precision, boolean, integer, boolean)
...
FUNCTION fixcorrupttopogeometrycolumn(name, name, name)
...
FUNCTION geog_brin_inclusion_merge(internal, internal)
...
FUNCTION geom2d_brin_inclusion_merge(internal, internal)
FUNCTION geom3d_brin_inclusion_add_value(internal, internal, internal, internal)
FUNCTION geom3d_brin_inclusion_merge(internal, internal)
FUNCTION geom4d_brin_inclusion_add_value(internal, internal, internal, internal)
FUNCTION geom4d_brin_inclusion_merge(internal, internal)
...
FUNCTION geometry_neq(geometry, geometry)
...
FUNCTION maketopologyprecise(name, geometry, double precision)
...
FUNCTION postgis_proj_compiled_version()
...
FUNCTION st_addedgemodface(character varying, bigint, bigint, geometry)
FUNCTION st_addedgemodface(character varying, integer, integer, geometry)
FUNCTION st_addedgenewfaces(character varying, bigint, bigint, geometry)
FUNCTION st_addedgenewfaces(character varying, integer, integer, geometry)
FUNCTION st_addisoedge(character varying, bigint, bigint, geometry)
FUNCTION st_addisoedge(character varying, integer, integer, geometry)
FUNCTION st_addisonode(character varying, bigint, geometry)
...
FUNCTION st_asgeojson(record, text, integer, boolean, text)
...
FUNCTION st_changeedgegeom(character varying, bigint, geometry)
...
FUNCTION st_clip(raster, geometry, boolean, boolean)
FUNCTION st_clip(raster, geometry, double precision, boolean)
FUNCTION st_clip(raster, geometry, double precision, boolean, boolean)
FUNCTION st_clip(raster, geometry, double precision[], boolean)
FUNCTION st_clip(raster, geometry, double precision[], boolean, boolean)
FUNCTION st_clip(raster, integer, geometry, boolean)
FUNCTION st_clip(raster, integer, geometry, boolean, boolean)
FUNCTION st_clip(raster, integer, geometry, double precision, boolean)
FUNCTION st_clip(raster, integer, geometry, double precision, boolean, boolean)
FUNCTION st_clip(raster, integer, geometry, double precision[], boolean)
FUNCTION st_clip(raster, integer[], geometry, double precision[], boolean)
FUNCTION st_clip(raster, integer[], geometry, double precision[], boolean, boolean)
...
FUNCTION st_coverageclean(geometry, double precision, double precision, text)
...
FUNCTION st_curven(geometry, integer)
...
FUNCTION st_getfaceedges(character varying, bigint)
FUNCTION st_getfaceedges(character varying, integer)
FUNCTION st_getfacegeometry(character varying, bigint)
...
FUNCTION st_intersectionfractions(raster, geometry)
...
FUNCTION st_modedgeheal(character varying, bigint, bigint)
FUNCTION st_modedgeheal(character varying, integer, integer)
FUNCTION st_modedgesplit(character varying, bigint, geometry)
FUNCTION st_modedgesplit(character varying, integer, geometry)
FUNCTION st_modedgessplit(character varying, integer, geometry)
FUNCTION st_moveisonode(character varying, bigint, geometry)
...
FUNCTION st_newedgeheal(character varying, bigint, bigint)
FUNCTION st_newedgeheal(character varying, integer, integer)
FUNCTION st_newedgessplit(character varying, bigint, geometry)
...
FUNCTION st_numcurves(geometry)
...
FUNCTION st_reclassexact(raster, double precision[], double precision[], integer, text, double precision)
...
FUNCTION st_remedgemodface(character varying, bigint)
FUNCTION st_remedgemodface(character varying, integer)
FUNCTION st_remedgenewface(character varying, bigint)
FUNCTION st_remedgenewface(character varying, integer)
FUNCTION st_remisonode(character varying, bigint)
FUNCTION st_remisonode(character varying, integer)
FUNCTION st_removeirrelevantpointsforview(geometry, box2d)
FUNCTION st_removeirrelevantpointsforview(geometry, box2d, boolean)
FUNCTION st_removeisoedge(character varying, bigint)
FUNCTION st_removeisoedge(character varying, integer)
FUNCTION st_removeisonode(character varying, bigint)
...
FUNCTION st_removesmallparts(geometry, double precision, double precision)
...
FUNCTION topogeo_loadgeometry(character varying, geometry, double precision)
...
FUNCTION totaltopologysize(name)
