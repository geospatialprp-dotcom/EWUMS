...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2026-06-08 21:50:52
...
DROP FUNCTION IF EXISTS ST_CoverageClean  (geom geometry, gapMaximumWidth float8 , snappingDistance float8 , overlapMergeStrategy text );
