export const en = {
  ...
  nav: {
    ...
    workflowCenter: 'Workflows',
    dprApprovalPipeline: 'DPR',
    landAcquisition: 'Land Acq.',
    projectManagement: 'Projects',
    omManagement: 'O&M',
    billingRevenue: 'Billing',
    mobileBilling: 'Mobile Bill',
    ...
    sectionAdministration: 'Admin',
    home: 'Home',
    tasks: 'Tasks',
    more: 'More',
    moreModules: 'More modules',
    fieldQuickActions: 'Field quick actions',
  },
  common: {
    loading: 'Loading…',
    save: 'Save',
