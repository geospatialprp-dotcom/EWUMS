# Department Presentation Outline — EWUMS for Uttarakhand Jal Sansthan

**Meeting type:** Department / division heads review  
**Duration:** 45–60 minutes (including 15 min live demo)  
**Platform URL:** https://ewumsujs.com  
...
**Footer:** PRP Geospatial Solutions · EWUMS · ewumsujs.com  
**Visual:** UJS emblem + PRP logo + map of Uttarakhand
...
**Visual:** Module group icons from `/platform` page
...
**Reference divisions:** Dehradun North (DIV-DNN), Haridwar Rural (DIV-HRR), Karanprayag (DIV-KPG), Nainital (DIV-NTL)
...
**Partial (roadmap):** Mobile workforce expansion, enterprise DMS, QR scan app, ML predictive maintenance
...
**Qualitative ROI:** Faster decision-making, reduced duplicate data entry, improved fund utilisation visibility for SFC/GoUK reporting.
...
**Contact block:** [Add PRP Geospatial contact details for meeting]
...
**Visual:** Map of Uttarakhand with phased division highlights
...
## Slide 19 — Appendix: Demo Credentials

*Print as handout — do not display on projector*

| Role | Email | Password | Division |
|------|-------|----------|----------|
| HQ Admin | admin@egip.local | Admin@123 | Statewide |
| Dehradun North EE | ee.dnn@egip.local | EE@123 | DIV-DNN |
| Dehradun North JE | je.dnn@egip.local | JE@123 | DIV-DNN |
| Haridwar Rural EE | ee.hrr@egip.local | EE@123 | DIV-HRR |
| Haridwar JE (legacy) | je@egip.local | JE@123 | DIV-HRW |

*Apply `demo-seed.sql` before meeting for division-specific accounts.*
...
**Footer:** PRP Geospatial Solutions · https://ewumsujs.com · EWUMS/S2T2R

**Call to action:** Approve pilot · Schedule training Week 1 · PRP to submit formal pilot plan (`PILOT-PLAN-90-DAYS.md`)

---

*Presentation outline v1.0 — prepared for UJS department meeting.*
