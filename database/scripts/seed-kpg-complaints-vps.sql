-- Paste on VPS: psql -U egip -d egip -f seed-kpg-complaints-vps.sql
-- Idempotent Karanprayag demo complaints + JE permissions (same as migration 088).
...
BEGIN
  ...
  IF v_project IS NULL THEN
    v_project := 'f0000000-0000-0000-0000-000000000001';
  END IF;
  ...
  RAISE NOTICE 'KPG complaints seeded for project %', v_project;
END $$;
