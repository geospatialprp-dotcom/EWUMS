...
-- Uses the PDF version Super Admin reviewed online (hq scope), NOT the latest EE upload.
...
reviewed_doc AS (
  SELECT d.id, d.version_no, d.file_name, r.updated_at
...
RETURNING pr.proposal_no,
          ...
          pr.hq_verification->'tacRound1'->'officialPackage'->>'versionNo' AS frozen_version,
