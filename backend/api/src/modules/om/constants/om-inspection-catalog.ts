...
export type ChecklistFieldType = 'number' | 'text' | 'select' | 'rating';
...
export const OM_INSPECTION_TYPES: OmInspectionTypeDef[] = [
  {
    ...
    fields: [
      ...
      { key: 'pumpRunningHours', label: 'Pump Running Hours', type: 'number', unit: 'hrs', required: true },
      { key: 'reservoirWaterLevel', label: 'Reservoir Water Level', type: 'number', unit: 'm', required: true },
      { key: 'flowMeterReading', label: 'Flow Meter Reading', type: 'number', unit: 'KL', required: true },
      { key: 'chlorineLevel', label: 'Chlorine Level', type: 'number', unit: 'ppm', required: true },
      { key: 'pressureReading', label: 'Pressure Reading', type: 'number', unit: 'kg/cm²', required: true },
      { key: 'powerConsumption', label: 'Power Consumption', type: 'number', unit: 'kWh', required: true },
...
export function getInspectionTypeDef(type: string): OmInspectionTypeDef | undefined {
  return OM_INSPECTION_TYPES.find((t) => t.type === type);
}
